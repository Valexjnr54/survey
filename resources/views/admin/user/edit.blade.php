              ...
              <div class="card-body">
                <form action="{{ route('admin.update-user', ['id' => $user->id])}}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" value="{{ $user->name }}" placeholder="Type here" class="form-control">
                    </div>

                    <div class="mb-4">
                        <label for="email" class="form-label">Email</label>
                        <input type="email" name="email" value="{{ $user->email }}" placeholder="Type here" class="form-control">
                    </div>
