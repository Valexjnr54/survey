                    ...
                    <div class="account-content">
                        <div class="row align-items-center justify-content-center">
                            ...
                            <div class="col-md-12 col-lg-6 login-right">
                                ...
                                <form method="POST" action="{{ route('admin.register.custom') }}">
                                    @csrf
                                    <div class="form-group form-focus" hidden>
                                        <input id="role" type="text" value="Admin" class="form-control floating @error('role') is-invalid @enderror" name="role" value="{{ old('role') }}" required autocomplete="role">
